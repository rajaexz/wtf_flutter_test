...
class SessionLogsNotifier
  ...
  Future<void> submitRating(SessionLogEntity log, int rating, String? note) async {
...
final filteredSessionLogsProvider = Provider.family<List<SessionLogEntity>, String>((ref, userId) {
  final logs = ref.watch(sessionLogsProvider(userId)).valueOrNull ?? [];
